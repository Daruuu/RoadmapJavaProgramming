...
//        String archivo = "testExer04.txt";
        String archivoPath = "/home/daruuu/IdeaProjects/RoadmapJavaProgramming/src/topic5_files/practica02_03/testExer04.txt";
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                for (String w : words) {
                    if (w.equals(strABuscar)) {
                        count++;
//                        count += contadorPalabras(line, strABuscar);
                    }
                }
            }
        } catch (IOException e) {
